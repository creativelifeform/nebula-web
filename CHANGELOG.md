...
- Releases link to nav which points to public release notes

## `v1.8.0` - 2020-12-16

### Added

- `SubscriberCheckbox` component to `Download` form to make newsletter subscriptions GDPR compliant
